...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { nombre: @contacto.nombre, numero: @contacto.numero } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { nombre: @contacto.nombre, numero: @contacto.numero } }
